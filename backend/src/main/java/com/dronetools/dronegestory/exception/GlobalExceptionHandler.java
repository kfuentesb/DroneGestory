package com.dronetools.dronegestory.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleMaxSizeException(MaxUploadSizeExceededException exc) {
        // 413 es el código estándar para Payload Too Large
        return ResponseEntity.status(413).body("Error en la subida: El servidor rechazó el archivo.");
    }
}
