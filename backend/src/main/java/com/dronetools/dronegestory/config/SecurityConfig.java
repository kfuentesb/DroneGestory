...
public class SecurityConfig {
    ...
    @Value("${app.frontend.url:https://${SERVER_IP}:5173}")
    ...
    public SecurityFilterChain filterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/home", "/auth/login", "/auth/logout").permitAll()
    
                        .requestMatchers(HttpMethod.GET, "/auth/users/me").authenticated()
                        .requestMatchers(HttpMethod.GET, "/auth/users/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/auth/users").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers("/auth/users/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/auth/aircraft/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers("/auth/aircraft/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers("/auth/pilots/**").hasAnyRole("ADMIN", "MANAGER")
